...
import com.fillsa.fillsa_api.domain.members.quote.dto.MemberMonthlyQuoteResponse
...
class QuoteService(): QuoteUseCase {
    ...
    override fun getMonthlyQuotes(yearMonth: YearMonth): MemberMonthlyQuoteResponse {
        return MemberMonthlyQuoteResponse(
            ...
            monthlySummary = MemberMonthlyQuoteResponse.MonthlySummaryData(
                typingCount = 2,
                likeCount = 3
            )
        )
